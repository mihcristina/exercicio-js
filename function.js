...
function getHTML(gulliverCodigo) {
    let codigoUm = gulliverCodigo.split("*");
    let cidades = codigoUm[1] + ", " + codigoUm[3] + ", " + codigoUm[5];
    alert(cidades);
    let codigoDois = gulliverCodigo.split("#");
    let roteiros = "São Paulo: " + codigoDois[1] + ", " + "Las Vegas: " + codigoDois[4] + "Moscou: " + codigoDois[7];
    alert(roteiros);
    let codigoTres = gulliverCodigo.split("<br>");
    let pontosTuristicos = "Centro: " + codigoTres[6];
    alert(pontosTuristicos);
    let downtown = "DownTown: " + codigoTres[15];
    alert(downtown);
}

getHTML(gulliverCodigo)